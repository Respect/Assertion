...
interface AllMixin
{
    public static function all(mixed $input, mixed $compareTo, null|string|Throwable $description = null): self;

    public static function allNot(mixed $input, mixed $compareTo, null|string|Throwable $description = null): self;
