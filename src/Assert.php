 ...
 * @method static void max($input, $compareTo, $description = null)
 * @method static void maxBetween($input, $min = null, $max = null, bool $inclusive = true, $description = null)
 * @method static void maxEven($input, $description = null)
 * @method static void maxFactor($input, int $dividend, $description = null)
 * @method static void maxFibonacci($input, $description = null)
 * @method static void maxIdentical($input, $value, $description = null)
 * @method static void maxMax($input, $maxValue, bool $inclusive = true, $description = null)
 * @method static void maxMin($input, $minValue, bool $inclusive = true, $description = null)
 * @method static void maxMultiple($input, int $multipleOf, $description = null)
 * @method static void maxNotBetween($input, $min = null, $max = null, bool $inclusive = true, $description = null)
 * @method static void maxNotEquals($input, $compareTo, $description = null)
 * @method static void maxNotEven($input, $description = null)
 * @method static void maxNotFactor($input, int $dividend, $description = null)
 * @method static void maxNotFibonacci($input, $description = null)
 * @method static void maxNotIdentical($input, $value, $description = null)
 * @method static void maxNotMax($input, $maxValue, bool $inclusive = true, $description = null)
 * @method static void maxNotMin($input, $minValue, bool $inclusive = true, $description = null)
 * @method static void maxNotMultiple($input, int $multipleOf, $description = null)
 * @method static void maxNotOdd($input, $description = null)
 * @method static void maxNotPerfectSquare($input, $description = null)
 * @method static void maxNotPositive($input, $description = null)
 * @method static void maxNotPrimeNumber($input, $description = null)
 * @method static void maxOdd($input, $description = null)
 * @method static void maxPerfectSquare($input, $description = null)
 * @method static void maxPositive($input, $description = null)
 * @method static void maxPrimeNumber($input, $description = null)
 * @method static void mimetype($input, string $mimetype, $description = null)
 * @method static void min($input, $compareTo, $description = null)
 * @method static void minBetween($input, $min = null, $max = null, bool $inclusive = true, $description = null)
 * @method static void minEven($input, $description = null)
 * @method static void minFactor($input, int $dividend, $description = null)
 * @method static void minFibonacci($input, $description = null)
 * @method static void minIdentical($input, $value, $description = null)
 * @method static void minimumAge($input, int $age, $description = null)
 * @method static void minMax($input, $maxValue, bool $inclusive = true, $description = null)
 * @method static void minMin($input, $minValue, bool $inclusive = true, $description = null)
 * @method static void minMultiple($input, int $multipleOf, $description = null)
 * @method static void minNotBetween($input, $min = null, $max = null, bool $inclusive = true, $description = null)
 * @method static void minNotEquals($input, $compareTo, $description = null)
 * @method static void minNotEven($input, $description = null)
 * @method static void minNotFactor($input, int $dividend, $description = null)
 * @method static void minNotFibonacci($input, $description = null)
 * @method static void minNotIdentical($input, $value, $description = null)
 * @method static void minNotMax($input, $maxValue, bool $inclusive = true, $description = null)
 * @method static void minNotMin($input, $minValue, bool $inclusive = true, $description = null)
 * @method static void minNotMultiple($input, int $multipleOf, $description = null)
 * @method static void minNotOdd($input, $description = null)
 * @method static void minNotPerfectSquare($input, $description = null)
 * @method static void minNotPositive($input, $description = null)
 * @method static void minNotPrimeNumber($input, $description = null)
 * @method static void minOdd($input, $description = null)
 * @method static void minPerfectSquare($input, $description = null)
 * @method static void minPositive($input, $description = null)
 * @method static void minPrimeNumber($input, $description = null)
