...
/**
 * @covers \Respect\Assertion\Chain\AssociativeFullChain
 * @covers \Respect\Assertion\Chain\FullChain
 */
final class AssociativeFullChainTest extends TestCase
{
    /**
     * @test
     */
    public function itShouldCreateChainWithPrefix(): void
    {
        ...
        $sut = new AssociativeFullChain($creator, $reference, $input, $description, $prefix);
        $sut->__call($name, []);
